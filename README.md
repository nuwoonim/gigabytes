...
- **[Qwen3_TTS_CPU_Optimization_Report.html](qwen3_tts_case_study/Qwen3_TTS_CPU_Optimization_Report.html)**: A comprehensive, publication-grade academic research paper (Korean) documenting the mathematical formalization, background hardware context, real-world CPU benchmarks, and the information-theoretic integration between neural weights streaming and Hangeul 15-bit phonology. Fully supports MathJax LaTeX math rendering and UTF-8 encoding.
- **[Qwen3_TTS_CPU_Optimization_Report.tex](qwen3_tts_case_study/Qwen3_TTS_CPU_Optimization_Report.tex)**: A publication-ready LaTeX source file (Korean, with `kotex`) prepared in dual-column format according to official arXiv guidelines, enabling instant compile and submission.
- **[Qwen3_TTS_CPU_Optimization_Report_EN.html](qwen3_tts_case_study/Qwen3_TTS_CPU_Optimization_Report_EN.html)**: The official English version of the academic research paper, formatted to identical visual standards for global publication.
- **[Qwen3_TTS_CPU_Optimization_Report_EN.tex](qwen3_tts_case_study/Qwen3_TTS_CPU_Optimization_Report_EN.tex)**: The arXiv-compliant, double-column LaTeX source code for the English version of the paper, using only standard global LaTeX packages for seamless compilation anywhere in the world.
