...
\title{가상 메모리 주소 매핑 및 BFloat16 수치 압축 기반의\\대형 생성형 AI 로컬 CPU 최적화 구동 연구:\\\large 1.7B 매개변수 Qwen3-TTS의 Zero-RAM 가중치 스트리밍 및 다중스레딩 제어 실증 분석}
\author{yeonwoo yu\\ \small \href{mailto:khgilom@gmail.com}{khgilom@gmail.com}}
\date{2026년 5월 26일}
